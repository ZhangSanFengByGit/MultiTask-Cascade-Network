...
optimizer_warm = torch.optim.Adam(fc.parameters(), lr = 0.0001)
...
for epoch in range(10):
	for sequence in vots:
	    ...
	    while True:
	        ...
	        #warped_map = bilinear(x_feat, res, BSrchFlag)
	        mask = fc(x_feat)
...
fc.eval().cpu()
#net.eval().cpu()
#torch.save(net.state_dict(),'./test_save/net30.pth')
torch.save(fc.state_dict(),'./test_save/fc_only.pth')
f.close()
